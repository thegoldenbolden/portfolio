...
export type Tag = 'Next.js' | 'Node.js' | 'React' | 'Typescript' | 'Side Project' | 'HTML5' | 'CSS3'
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ['Next.js', 'React', 'Typescript', 'Side Project'],
    description: 'Explore an extensive pokemon card database and find prices about any card',
    year: "2022",
    status: 'now'
  },
  {
